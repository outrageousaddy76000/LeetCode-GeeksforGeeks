<h2><a href="https://practice.geeksforgeeks.org/problems/minimum-swaps/1?page=1&sprint=a663236c31453b969852f9ea22507634&sortBy=difficulty">Minimum Swaps to Sort</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array of n distinct elements. Find the minimum number of swaps required to sort the array in strictly increasing&nbsp;order.</span></p>
